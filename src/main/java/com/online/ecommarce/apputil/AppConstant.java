...
public class AppConstant {
	...
	public static final String  PLEASE_SEND_USER_ID_AND_PRODUCT_ID="Please send user Id and Product Id";
	...
	public static final String GET_USER_DATA_IN_CART_SUMMARY= "Get User cart summary data";
